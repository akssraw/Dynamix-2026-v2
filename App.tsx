...
// BRAND ASSET IMPORT
import logoAsset from './assets/dynamix-logo.png'import { useState, useEffect, useRef } from 'react'
import { motion, AnimatePresence } from 'framer-motion'
import { ArrowRight, ArrowUp, X } from 'lucide-react'
...
// Condensed Front-Page Grid Event Brief Datastructure Matrix
const DX_2026_EVENTS = [
  {
    ...
    eligibility: "Classes: 1-2 (1 Participant from each) | Teams: 1 (2 members)",
    hashtag: "#TUX PAINT",
    desc: "Digital artwork creation engine challenge. Bring themes to life using the creative vector tools of the Tux Paint platform.",
    details: [
  ...
  },
  {
    ...
    category: "Design",
    venue: "Google Form Submission",
    eligibility: "Classes: 3-4 (1 Participant from each class) | Teams: 1 (2 members)",
    hashtag: "#PRESENTATION",
    desc: "Creative presentation layout sprint. Blend structural storytelling, animations, and typography inside a 7-8 slide PowerPoint deck.",
    details: [
  ...
  },
  {
    ...
    category: "Coding",
    venue: "Google Form Submission",
    eligibility: "Classes: 5 | Teams: 1 (2 members)",
    hashtag: "#SCRATCH",
    desc: "Interactive visual game mechanics. Map complex object coordinates and behavioral loops to design an automated workspace project in Scratch.",
    details: [
  ...
  },
  {
    ...
    eligibility: "Classes: 6-7 (1 Participant from each) | Teams: 1 (2 members)",
    hashtag: "#CANVA",
    desc: "Conceptual graphic design and canvas styling layout challenge using Canva framework assets to engineer an internet safety poster profile.",
    details: [
  ...
  },
  {
    ...
    eligibility: "Classes: 6-8 (Any class) | Teams: 1 (2 members)",
    hashtag: "#APP MAKING",
    desc: "Mobile application interface prototyping. Develop a working 3-4 screen software application targeting domestic environmental tasks.",
    details: [
  ...
  },
  {
    ...
    eligibility: "Classes: 7-8 (1 From each) | Teams: 1 (2 members)",
    hashtag: "#CODING",
    desc: "Algorithmic logic race. Solve data structure variables, math matrices, and sorting problem-sets inside a fixed competitive window.",
    details: [
  ...
  },
  {
    ...
    category: "Design",
    venue: "Google Form Submission",
    eligibility: "Classes: 7-9 (Participant from any class) | Teams: 1 (2 members)",
    hashtag: "#THE EDUCATIONAL TECH MEME CHALLENGE",
    desc: "High-contrast computing humor design. Assemble a square format digital meme explaining system engineering paradoxes or runtime issues.",
    details: [
  ...
  },
  {
    ...
    desc: "Complex data-mapping challenge. Convert technology systems, timelines, and security mechanics into custom portrait layouts.",
    details: [
  ...
  },
  {
    ...
    eligibility: "Classes: 8-9 (One participant from each) | Teams: 1 (2 members)",
    hashtag: "#PROMPT AI ENGINEERING",
    desc: "Prompt engineering sprint. Orchestrate well-structured, logical commands to guide LLM generative engines into delivering error-free output contexts.",
    details: [
  ...
  },
  {
    ...
    eligibility: "Classes: 8-10 (Participant from any class) | Teams: 1 (2 members)",
    hashtag: "#THE TECH REEL CHALLENGE",
    desc: "Vertical cinematic storytelling. Edit an original vertical micro-documentary separating technical myths from verified reality patterns.",
    details: [
  ...
  },
  {
    ...
    eligibility: "Classes: 8-9 (Any class) | Teams: 1 (2 members)",
    hashtag: "#THE TECHNICAL BLOGGING CHALLENGE",
    desc: "Technical writing and research case architecture. Format professional tech publications detailing modern software scaling models.",
    details: [
  ...
  },
  {
    ...
    eligibility: "Classes: 9-10 (One from each) | Teams: 1 (2 members)",
    hashtag: "#VIDEO EDITING",
    desc: "Post-production video montage editing. Re-sequence raw footage vectors into a synchronized audio-visual showcase on Discord.",
    details: [
  ...
  },
  {
    ...
    desc: "Full-stack layout engineering sprint. Code responsive, high-fidelity interface applications with clean web semantic layers.",
    details: [
  ...
  },
  {
    ...
    eligibility: "Classes: 9-10 (One from each) | Teams: 1 (2 members)",
    hashtag: "#DESIGNING",
    desc: "Visual branding asset compilation. Render UI components, dark-theme styling layouts, and manual illustrations using industry graphics suites.",
    details: [
  ...
  },
  {
    ...
    eligibility: "Classes: 9-12 (One from each) | Teams: 1 (2 members)",
    hashtag: "#PHOTOGRAPHY (DSLR/MIRRORLESS)",
    desc: "Optics and light balance capture. Command manual camera settings to expose composition profiles without automated AI manipulation.",
    details: [
  ...
  },
  {
    ...
    mode: "OFFLINE",
    category: "Gaming",
    venue: "Senior CS Lab (Finals Node)",
    eligibility: "Classes: 11-12 (One from each) | Teams: 1 (2 members)",
    hashtag: "#GAMING PC",
    desc: "High-intensity PC performance shootout. Put your map coordination, strategy nodes, and mechanical mouse reflexes to the ultimate arena test.",
    details: [
  ...
  },
  {
    ...
    mode: "HYBRID",
    category: "Quiz",
    venue: "Main Auditorium Deck",
    eligibility: "Classes: 11-12 (One from each) | Teams: 1 (2 members)",
    hashtag: "#QUIZ",
    desc: "Elite computer lore and cybersecurity technical quiz. Parse cryptographic queries, computing history, and algorithmic paradigms.",
    details: [
  ...
  },
  {
    ...
    mode: "HYBRID",
    category: "Quiz",
    venue: "Main Assembly Area",
    eligibility: "Classes: 9-12 (Participant from any class) | Teams: 1 (2 members)",
    hashtag: "#IDEA PITCHING",
    desc: "Technical founder framework. Deliver startup-style system pitches targeting market models, monetization pipelines, and code scalability scales.",
    details: [
  ...
  },
  {
    ...
    mode: "HYBRID",
    category: "Video",
    venue: "On-Site Production Enclosure",
    eligibility: "Classes: 9-12 (One participant from each) | Teams: 1 (2 members)",
    hashtag: "#MOVIE MAKING",
    desc: "Cinematography and production workflow task. Script, shoot, and edit a short cinematic concept layout addressing theme prompts.",
    details: [
  ...
  },
  {
    ...
    mode: "HYBRID",
    category: "Coding",
    venue: "Vite Core Client Lab",
    eligibility: "Classes: 11-12 (One from each) | Teams: 1 (2 members)",
    hashtag: "#CODING",
    desc: "Advanced logic optimization sprint. Code structural data schemas, algorithmic matrices, and custom multi-language routines under heavy system strain.",
    details: [
      "Participants will solve a set of algorithmic and logical programming problems within a specified time limit.",
      "Problems will assess logical reasoning, data structures, algorithms, mathematics, and problem-solving skills.",
      "Teams may submit solutions in any programming language supported by the competition platform.",
  ...
  },
  {
    ...
    mode: "OFFLINE",
    category: "Gaming",
    venue: "Console Sandbox Lab Enclosure",
    eligibility: "Classes: 11-12 (One participant from each) | Teams: 1 (2 members)",
    hashtag: "#GAMING CONSOLE",
    desc: "Reflex matchmaking challenge. Go head-to-head on precision console frameworks across tactical survival, sports, and platform genres.",
    details: [
  ...
  },
  {
    ...
    mode: "HYBRID",
    category: "Coding",
    venue: "Discord Hunt Channel Vault",
    eligibility: "Classes: 11-12 (One from each) | Teams: 1 (2 members)",
    hashtag: "#CRYPTIC HUNT",
    desc: "A symmetric 48-hour continuous technical cryptic capture-the-flag (CTF) hunt. Reverse-engineer directories, cipher lines, and metadata paths.",
    details: [
  ...
  },
  {
    ...
    mode: "OFFLINE",
    category: "Quiz",
    venue: "Physics Engineering Deck",
    eligibility: "Classes: 11-12 (One from each) | Teams: 1 (2 members)",
    hashtag: "#SURPRISE",
    desc: "Mystery parameter optimization. Unbox undisclosed technological hardware parts or logic problems to construct on-site prototypes.",
    details: [
  ...
  },
  {
    ...
    mode: "OFFLINE",
    category: "Robotics",
    venue: "Badminton Court Grid Enclosure",
    eligibility: "Classes: 9-10 (One participant from each) | Teams: 1 (2 members)",
    hashtag: "#ROBOTICS",
    desc: "Adrenaline-fueled mechanical football. Build a wheeled, battery-powered automated machine custom engineered to score targets inside fixed sizes.",
    details: [
  ...
  },
  {
    ...
    mode: "OFFLINE",
    category: "Robotics",
    venue: "Badminton Combat Grid Enclosure",
    eligibility: "Classes: 11-12 (One from each) | Teams: 1 (2 members)",
    hashtag: "#ROBOTICS",
    desc: "Kinetic durability robot combat event. Construct a 10kg max custom wheeled bot designed for multi-player free-for-all disruptions.",
    details: [
    ...
    <div className="min-h-screen bg-[#050507] text-neutral-200 selection:bg-[#00fa6c] selection:text-black antialiased relative">
      ...
      {!isLoading && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
          ...
          {/* 🟢 ADJUSTED SMOOTHING GLASSMORPHISM TRANSITION INTERFACE OVERLAY */}
          <AnimatePresence mode="wait">
            {activeEvent && (
              <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-6 overflow-hidden">
                
                {/* Backdrop Blur Layer with Smooth Linear Easing Fade */}
                <motion.div 
                ...
                {/* Main Expanded Glass Container with Balanced Kinetic Physics Spring */}
                <motion.div 
                  ...
                  className="relative w-full max-w-2xl bg-zinc-950/90 border border-[#00fa6c]/30 backdrop-blur-2xl p-8 md:p-10 rounded-3xl z-10 shadow-[0_25px_60px_-15px_rgba(0,250,108,0.2)] flex flex-col justify-between max-h-[85vh] overflow-y-auto select-none"
                >
                  {/* Close Cross Anchor */}
                  <button 
                    onClick={() => setActiveEvent(null)}
                    className="absolute top-6 right-6 p-2 rounded-full border border-white/10 bg-white/5 text-neutral-400 hover:text-white hover:bg-white/10 transition-all duration-200"
                  >
                    <X className="h-4 w-4" />
                  </button>

                  <div>
                    {/* Retro Big Bolder Heading Profile */}
                    <h2 className="text-4xl md:text-5xl font-mono font-black text-white mb-6 uppercase tracking-tighter text-center md:text-left drop-shadow-[0_0_30px_rgba(255,255,255,0.15)]">
                      {activeEvent.title}
                    </h2>

                    {/* Operational Variables Row Block */}
                    <div className="flex flex-wrap gap-3 mb-6 p-4 rounded-xl border border-white/5 bg-white/[0.01] font-mono text-[10px] tracking-wider text-neutral-400 uppercase">
                      <div><span className="text-[#00fa6c]">MODE OF CONDUCT:</span> {activeEvent.mode}</div>
                      <div className="hidden md:block text-neutral-700">|</div>
                      <div><span className="text-[#00fa6c]">SUBMISSION FORMAT:</span> {activeEvent.venue}</div>
                      <div className="hidden md:block text-neutral-700">|</div>
                    </div>

                    {/* Lower Details Content Array in Small Retro Font Layer */}
                    <div className="space-y-6 font-mono text-xs text-neutral-400 leading-relaxed border-t border-white/[0.08] pt-6 my-6 select-text">
                      
                      {/* Eligibility Block */}
                      {activeEvent.eligibility && (
                        <div className="border border-white/5 bg-neutral-900/40 p-3.5 rounded-xl border-l-2 border-l-[#00fa6c]">
                          <span className="text-[#00fa6c] font-bold uppercase text-[9px] block mb-1 tracking-widest">ELIGIBILITY CRITERIA:</span>
                          <span className="text-neutral-200 text-[11px]">{activeEvent.eligibility}</span>
                        </div>
                      )}

                      {/* Brief Card Block */}
                      <div>
                        <div className="text-[#00fa6c] font-bold uppercase tracking-widest mb-2 text-[9px]">DESCRIPTION:</div>
                        <p className="text-neutral-300 font-light bg-neutral-900/60 p-4 rounded-xl border border-white/5 leading-loose">{activeEvent.desc}</p>
                      </div>

                      {/* Specifications Generation Pipeline */}
                      {activeEvent.details && activeEvent.details.length > 0 && (
                        <div>
                          <div className="text-[#00fa6c] font-bold uppercase tracking-widest mb-2 text-[9px]">SPECIFICATIONS:</div>
                          <ul className="space-y-2 pl-1 font-light">
                            {activeEvent.details.map((detail, index) => (
                              <li key={index} className="flex items-start gap-2 text-neutral-300">
                                <span className="text-[#00fa6c] mt-0.5 text-[9px]">►</span> <span>{detail}</span>
                              </li>
                            ))}
                          </ul>
                        </div>
                      ...
                      {/* Guidelines Generation Pipeline */}
                      {activeEvent.guidelines && activeEvent.guidelines.length > 0 && (
                        <div>
                          <div className="text-[#00fa6c] font-bold uppercase tracking-widest mb-2 text-[9px]">GUIDELINES:</div>
                          <ul className="space-y-2 pl-1 font-light">
                            {activeEvent.guidelines.map((guide, index) => (
                              <li key={index} className="flex items-start gap-2 text-neutral-400">
                                <span className="text-[#00fa6c]/60 mt-0.5 text-[9px]">■</span> <span>{guide}</span>
                              </li>
                            ))}
                          </ul>
                        </div>
                  ...
                  {/* Register Direct Anchor Button Node at Bottom */}
                  <div className="pt-4 border-t border-white/[0.06]">
                    ...
                    >
                      <button className="w-full py-4 rounded-xl bg-[#00fa6c] text-black font-mono font-bold uppercase tracking-widest text-xs hover:bg-white hover:text-black hover:shadow-[0_0_30px_rgba(255,255,255,0.25)] transition-all duration-300 shadow-[0_10px_30px_rgba(0,250,108,0.2)]">
